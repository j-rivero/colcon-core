...
class ArgumentParserDecorator:
    ...
    def __init__(self, parser, **kwargs):
        ...
        assert '_nested_group_decorators' not in kwargs
        kwargs['_nested_group_decorators'] = []
        assert '_nested_nongroup_decorators' not in kwargs
        kwargs['_nested_nongroup_decorators'] = []
    ...
    def add_argument_group(self, *args, **kwargs):
        ...
        self._nested_group_decorators.append(group)
        return group
    ...
    def add_parser(self, *args, **kwargs):
        ...
        self._nested_nongroup_decorators.append(parser)
        return parser
    ...
    def add_subparsers(self, *args, **kwargs):
        ...
        self._nested_nongroup_decorators.append(subparser)
        return subparser
